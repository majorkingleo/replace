...
#ifndef lint
    static char SCCSID [] = "@(#)tr_rbg.c	1.5 11/29/95 09:33:38"; 
#endif 
...
+*  Rev  Date       Comment                                         By
+*  ---  ---------  ----------------------------------------------  ---
+*    0  17-Aug-95  created (from) IGGS                             cat
+*    0  04-Sep-95  copied  (from) IGGS                             cat
+*
+*		$Log: tr_rbg.c,v $
+*		Revision 1.4  2010/11/09 08:52:31  wamas
+*		cleanup_checks -> clean STORNO
+*		
+*		Revision 1.3  2010/06/25 14:25:08  wamas
+*		MOBERZA Statt llr_log_printf verwende normales LogPrintf und schon
+*		gibt es keine 600MB Logfiles mehr.
+*
+*		Revision 1.2  2004/03/23 08:19:14  cwiedne
+*		Add include - Files to remove Warnings like "Missing Prototype"
+*		
+*
+*
+******************************************************************************/
